...
class EmployingScreenUpdate extends StatefulWidget {
  const EmployingScreenUpdate({Key? key}) : super(key: key);

  @override
  _EmployingScreenUpdateState createState() => _EmployingScreenUpdateState();
}

class _EmployingScreenUpdateState extends State<EmployingScreenUpdate> {
  ...
  @override
  void initState() {
    _jobTitle.text=Provider.of<Edit>(context,listen: false).jobTitle==''?'':Provider.of<Edit>(context,listen: false).jobTitle;
    _jobDescription.text=Provider.of<Edit>(context,listen: false).description==''?'':Provider.of<Edit>(context,listen: false).description;
    _JobTypeSelectedValue=Provider.of<Edit>(context,listen: false).jobType==''?'':Provider.of<Edit>(context,listen: false).jobType;
    _JobCategorySelectedValue=Provider.of<Edit>(context,listen: false).jobCategory==''?'':Provider.of<Edit>(context,listen: false).jobCategory;
    _yearsOfExperienceNeededSelectedValue=Provider.of<Edit>(context,listen: false).experience==''?'':Provider.of<Edit>(context,listen: false).experience;
    _CurrentEducationLevelSelectedValue=Provider.of<Edit>(context,listen: false).education==''?'':Provider.of<Edit>(context,listen: false).education;
    _jobRequirements.text=Provider.of<Edit>(context,listen: false).requirements==''?'':Provider.of<Edit>(context,listen: false).requirements;
    if(Provider.of<Edit>(context,listen: false).salary==''||Provider.of<Edit>(context,listen: false).salary=='Confidential salary'){
      checkBoxValue=true;
    }else{
      _salary.text=Provider.of<Edit>(context,listen: false).salary;
    }
    super.initState();
