...
class personalInfoScreen2 extends StatefulWidget {
  const personalInfoScreen2({Key? key}) : super(key: key);
...
//CvUploadScreen().createState().firstName.toString()
  ...
  void initState() {
    ...
    _fNameController.text=Provider.of<userDetailView>(context,listen: false).fname==""?"":Provider.of<userDetailView>(context,listen: false).fname;
    _lNameController.text=Provider.of<userDetailView>(context,listen: false).lname==""?"":Provider.of<userDetailView>(context,listen: false).lname;
    // _phonenumController.text=Provider.of<userDetailView>(context,listen: false)==""?"":Provider.of<postfile>(context,listen: false).mobileNumber;
    ...
    // _selectedValue2=Provider.of<userDetailView>(context,listen: false).fname==""?"Egypt":Provider.of<postfile>(context,listen: false).country;
  ...
  Future<void> _submit() async {
    ...
    try {
      await Provider.of<personalInfoAuth2>(context, listen: false)
          .personalInfo2(email!,birthdate,mobNumber,gender,nationality,country,city,area);
    } catch(e) {
      throw e;
    }
    if(Provider.of<personalInfoAuth2>(context,listen: false).theresponse=='Success'){
            ...
            Padding(
              ...
              child: Column(
                ...
                children: [
                  ...
                  Center(
                    child:Text('${Provider.of<personalInfoAuth2>(context,listen: false).theError!=''?Provider.of<personalInfoAuth2>(context,listen: false).theError:''}',style: GoogleFonts.nunito(fontSize: 20,color: Colors.red,),),
                  ),
                  SizedBox(
                    height: 20,
                  ),
