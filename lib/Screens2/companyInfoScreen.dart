...
class _OnboardState extends State<Onboard> {
  ...
  late FocusNode _companyInfoFocusNode;
  late FocusNode _locationFocusNode;
  late FocusNode _foundedFocusNode;
  ...
  void initState() {
    ...
    _companyInfoFocusNode=FocusNode();
    _locationFocusNode=FocusNode();
    _foundedFocusNode=FocusNode();
  }
              ...
              child: SingleChildScrollView(
                child: Padding(
                  ...
                  child: Column(
                    children: [
                      SizedBox(height: 20,),
                      inputFile(label: "Website",TextInputType: TextInputType.emailAddress , hintText:'www.example.com',controller: _website,errorText: _WebsiteValidation,onChangedText: _textWebsite,focusNode: _websiteFocusNode ),
                      SizedBox(height: 10,),
                      inputFile(label: "Founded",TextInputType: TextInputType.number , hintText:'1980',controller: _founded,errorText: _foundedValidation,onChangedText: _textFounded,focusNode: _foundedFocusNode ),
              ...
              child: SingleChildScrollView(
                child: Padding(
                  ...
                  child: Column(
                    children: [
                      SizedBox(height: 20,),
                      maxLineInputFile(label: "Company Info" ,TextInputType: TextInputType.multiline , hintText:'Write a brief description about your company',controller: _companyInfo,errorText: _CompanyInfoValidation,onChangedText: _textCompanyInfo,focusNode: _companyInfoFocusNode ),
                      SizedBox(height: 10,),
                      Row(
                        children: [
                      ...
                      SizedBox(height: 10,),
                      inputFile(label: "Location" , hintText:'2438 6th Ave, Ketchikan,Alaska USA',controller: _location,errorText: _LocationValidation,onChangedText: _textLocation,focusNode: _locationFocusNode ),
                      SizedBox(height: 20,),
                      SmoothPageIndicator (
                          controller:controller,
                          count:2
  ...
  Future<void> saveCompanyInfo(String website,String companyInfo,String location,String founded,headquarterSelectedValue,companyIndustrySelectedValue,companySizeSelectedValue,specialtiesSelectedValue,typeSelectedValue,String mail ) async {
    if (_WebsiteValidation == null && _LocationValidation == null && _CompanyInfoValidation == null&&_foundedValidation==null) {
      setState(() {
        // _isloading = true;
      });
...
//                             final prefs=await SharedPreferences.getInstance();
//                             Email=prefs.getString('mail')!;
//                            await saveCompanyInfo( _website.text, _companyInfo.text, _location.text, _founded.text, _HeadquarterSelectedValue, _CompanyIndustrySelectedValue, _CompanySizeSelectedValue,_SpecialtiesSelectedValue, _TypeSelectedValue);
//                             await Provider.of<companyDetailView>(context,listen: false).fetchDetails(Email);
//                             await Provider.of<companyReviews>(context,listen: false).fetchReviews(Email);
//                             await Provider.of<companyJobs>(context,listen: false).fetchjobs(Email);
//                             Navigator.push(context, MaterialPageRoute(builder: (context) => companyPrivateProfile(),));
...
//   }
//
//    Future<void> saveCompanyInfo(String website,String companyInfo,String location,String founded,headquarterSelectedValue,companyIndustrySelectedValue,companySizeSelectedValue,specialtiesSelectedValue,typeSelectedValue ) async {
//      if (_WebsiteValidation == null && _LocationValidation == null && _CompanyInfoValidation == null && _foundedValidation==null) {
//        setState(() {
//          // _isloading = true;
//        });
